...
$$
\begin{align}
&l=0:\frac{(2l+1)\pi}{n-m}=\frac{\pi}3=60\degree\\
&l=1:\frac{3\pi}3=\pi=180\degree\\
...
![image-20230410184417545](4.%E6%A0%B9%E8%BD%A8%E8%BF%B9%E6%B3%95.assets/image-20230410184417545.png)

### 「4-6」

1.  $z_1=2,p_1=0,p_2=-3,p_{3,4}=-1\pm i$ 

2. 判断实轴上的根轨迹

3. 渐近线 $n=4,m=1$ 

4. 起始角 $\theta_{p3}=\angle(p_3-z_1)-[\angle(p_3-p_1)+\angle(p_3-p_2)+\angle(p_3-p_4)]=45\degree-(135\degree+26\degree+90\degree)+180\degree=26\degree$ 

5. 特征方程 $1+\frac{s+2}{s(s+3)(s^2+2s+2)}=0$ 

   解得 $\omega=\pm1.61$ ， $k=7.03$ 

6. 与虚轴交点 $(0,\pm\sqrt3j)$ 

<img src="4.%E6%A0%B9%E8%BD%A8%E8%BF%B9%E6%B3%95.assets/image-20230412083308184.png" alt="image-20230412083308184" style="zoom:25%;" />
